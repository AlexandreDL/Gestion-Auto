...
final class Version20200312155344 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vehicle_equipment (vehicle_id INT NOT NULL, equipment_id INT NOT NULL, nom_long VARCHAR(255) NOT NULL, weight INT NOT NULL, INDEX IDX_248790D1545317D1 (vehicle_id), INDEX IDX_248790D1517FE9FE (equipment_id), PRIMARY KEY(vehicle_id, equipment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
